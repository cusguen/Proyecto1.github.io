...
public class Registro
{
        ...
        for(int i = 0; i < numAprendices1; i++){
            ...
            miAcademia.adicionarAprendizMoto(nombre, cedula, tipoLicencia, notaTeoria, notaCircuito);
        }
        ...
        for(int i = 0; i < numAprendices2; i++){
            ...
            miAcademia.adicionarAprendizCarro(nombre,cedula, tipoLicencia, notaTeoria, notaCircuito, notaCarretera);
        }
        ...
        for(int i = 0; i < numAprendices3; i++){
            ...
            System.out.println("Digite la Cedula delAprendiz: ");
            cedula = sc.next();
            System.out.println("Digite el nombre del Aprendiz: ");
            nombre = sc.next();
            System.out.println("Digite el tipoLicencia del Aprendiz: ");
        ...
        System.out.println("\n El promedio de Registro es: " + promedio); 
    }
}
